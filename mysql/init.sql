...
GRANT ALL PRIVILEGES ON ads_database.* TO 'dotskin'@'%';
FLUSH PRIVILEGES;
...
--
-- Хост: localhost
-- Время создания: Дек 10 2024 г., 14:56
...
(1, 1, 'Продается уютная квартира в центре города', 'Продается 2-комнатная квартира площадью 60 кв. м. на 5 этаже. Вся мебель остается. Рядом парк и магазины.', 8500000.00, 'https://i.ibb.co/4VCC7T5/Ad-1-1.jpg', '[\"https://i.>
